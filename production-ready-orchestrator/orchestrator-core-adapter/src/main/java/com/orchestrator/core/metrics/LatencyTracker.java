...
/**
 * High-performance latency tracking and metrics collection component.
 * Tracks end-to-end message processing latency and counts slow messages.
 */
@Component
public class LatencyTracker {
    ...
    /**
     * Record consumer latency (from send to consumer receipt)
     */
    ...
    /**
     * Record processing latency (transformation time)
     */
    ...
    /**
     * Record publishing latency (Kafka publish time)
     */
