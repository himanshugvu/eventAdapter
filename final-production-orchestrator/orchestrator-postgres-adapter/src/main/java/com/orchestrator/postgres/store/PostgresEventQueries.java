...
public final class PostgresEventQueries {
    ...
    private static final String EVENT_ROW_MAPPER_FIELDS = """
        id, payload, topic_partition, offset_value, status, 
        received_at, processed_at, updated_at, error_message, 
        send_timestamp_ns, received_at_orchestrator, published_at, 
        total_latency_ms, consumer_latency_ms, processing_latency_ms, 
        publishing_latency_ms, created_at
        """;
}